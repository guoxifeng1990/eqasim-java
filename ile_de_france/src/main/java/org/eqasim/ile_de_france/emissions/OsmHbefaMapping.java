...
public class OsmHbefaMapping {
    ...
    private String getHEBFAtype(String roadType, double freeVelocity) {
        ...
        int freeVelocity_kmh_int = (int)Math.ceil(freeVelocity_kmh / 10.0);
        int capped_speed = (int) Math.min(Math.max(min_speed, freeVelocity_kmh_int * 10), max_speed);
